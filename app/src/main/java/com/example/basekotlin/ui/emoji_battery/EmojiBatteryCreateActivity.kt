...
import com.example.basekotlin.databinding.ActivityEmojiBaterryCreateBinding
...
class EmojiBatteryCreateActivity :
    BaseActivity<ActivityEmojiBaterryCreateBinding>(ActivityEmojiBaterryCreateBinding::inflate) {
    ...
    override fun getData() {
        ...
        Glide.with(this).load(PrefManager.pathBatteryEmojiCreateIcon).into(binding.ivPin)
        Glide.with(this).load(PrefManager.pathBatteryEmojiCreateBattery).into(binding.ivPinBg)

        binding.rcvBattery.apply {
            setHasFixedSize(true)
            batteryAdapter = BatteryAdapter {
                PrefManager.pathBatteryEmojiCreateBattery = it.url
        ...
        binding.rcvEmoji.apply {
            ...
            iconAdapter = IconAdapter { data ->
                ...
                PrefManager.pathBatteryEmojiCreateIcon = data.url
        ...
        viewModel.icons.observe(this) { icons ->
            ...
            listIcon.forEach {
                it.isActive = it.url.contains(PrefManager.pathBatteryEmojiCreateIcon)
            }
            updateIcon()
            if (PrefManager.pathBatteryEmojiCreateIcon != "") {
        ...
        viewModel.batteries.observe(this) { batteries ->
            ...
            updateBattery()
            if (PrefManager.pathBatteryEmojiCreateBattery != "") {
    ...
    override fun initView() {
        binding.apply {
            ...
            colorPickerDialog = ColorPickerDialog(this@EmojiBatteryCreateActivity, onClick = {
    ...
    override fun bindView() {
        binding.apply {
            ...
            ivStatus.tap {
                PermissionDialog(this@EmojiBatteryCreateActivity) {
    ...
    private fun updateIcon() {
        listIcon.forEach { it.battery = PrefManager.pathBatteryEmojiCreateBattery }
    ...
    private fun updateBattery() {
        listBattery.forEach {
            it.isActive = it.url.contains(PrefManager.pathBatteryEmojiCreateBattery)
        }
