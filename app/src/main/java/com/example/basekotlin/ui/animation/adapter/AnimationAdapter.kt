...
import com.example.basekotlin.databinding.ItemAnimationBinding

class AnimationAdapter(var onClick: (AnimationModel) -> Unit) :
    BaseAdapter<AnimationModel, ItemAnimationBinding>() {

    override fun setBinding(
        inflater: LayoutInflater,
        parent: ViewGroup,
        viewType: Int,
    ): ItemAnimationBinding {
        return ItemAnimationBinding.inflate(inflater, parent, false)
    }
    ...
    override fun setData(
        binding: ItemAnimationBinding, item: AnimationModel, layoutPosition: Int
    ) {
        binding.apply {
            context?.let {
            ...
            root.setBackgroundResource(if (item.isActive) R.drawable.bg_radius_16_stroke_01_animation else R.drawable.bg_radius_16)
        }
    }
